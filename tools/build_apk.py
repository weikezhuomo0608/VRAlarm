...
p.add_argument('--keystore',required=True);p.add_argument('--password-file',required=True);p.add_argument('--alias',default='hazelrelease');p.add_argument('--output',default='build/VRAlarm-1.1.1.apk')
p.add_argument('--version-code',default='26');p.add_argument('--version-name',default='1.1.1')
